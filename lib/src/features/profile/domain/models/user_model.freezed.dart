...
PulseUser _$PulseUserFromJson(Map<String, dynamic> json) {
  return _PulseUser.fromJson(json);
}
...
mixin _$PulseUser {
  ...
  PulseGender get gender => throw _privateConstructorUsedError;
  int? get dob => throw _privateConstructorUsedError;
  List<String> get searchKeys => throw _privateConstructorUsedError;
  PulseOnlineStatus get onlineStatus => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $PulseUserCopyWith<PulseUser> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PulseUserCopyWith<$Res> {
  factory $PulseUserCopyWith(PulseUser value, $Res Function(PulseUser) then) =
      _$PulseUserCopyWithImpl<$Res, PulseUser>;
  @useResult
  $Res call(
      {String? uid,
      String? name,
      ...
      PulseOnlineStatus onlineStatus,
      int? lastOnlineAt,
      int feedsCount,
      int photosCount,
      int videosCount,
...
/// @nodoc
class _$PulseUserCopyWithImpl<$Res, $Val extends PulseUser>
    implements $PulseUserCopyWith<$Res> {
  _$PulseUserCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PulseUserImplCopyWith<$Res>
    implements $PulseUserCopyWith<$Res> {
  factory _$$PulseUserImplCopyWith(
          _$PulseUserImpl value, $Res Function(_$PulseUserImpl) then) =
      __$$PulseUserImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? uid,
...
/// @nodoc
class __$$PulseUserImplCopyWithImpl<$Res>
    extends _$PulseUserCopyWithImpl<$Res, _$PulseUserImpl>
    implements _$$PulseUserImplCopyWith<$Res> {
  __$$PulseUserImplCopyWithImpl(
      _$PulseUserImpl _value, $Res Function(_$PulseUserImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$PulseUserImpl implements _PulseUser {
  const _$PulseUserImpl(
      {this.uid,
      this.name,
      this.userName,
      this.email,
      ...
      this.bio,
      this.profession,
      this.gender = PulseGender.unknown,
      this.dob,
      final List<String> searchKeys = const <String>[],
      this.onlineStatus = PulseOnlineStatus.unknown,
      this.lastOnlineAt,
      this.feedsCount = 0,
      this.photosCount = 0,
      this.videosCount = 0,
  ...
  factory _$PulseUserImpl.fromJson(Map<String, dynamic> json) =>
      _$$PulseUserImplFromJson(json);
  ...
  @override
  @JsonKey()
  final PulseOnlineStatus onlineStatus;
  @override
...
//ignore:invalid_annotation_target
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PulseUserImplCopyWith<_$PulseUserImpl> get copyWith =>
      __$$PulseUserImplCopyWithImpl<_$PulseUserImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PulseUserImplToJson(
      this,
    );
  }
}

abstract class _PulseUser implements PulseUser {
  const factory _PulseUser(
      {final String? uid,
      final String? name,
      final String? userName,
      final String? email,
      ...
      final bool visibility,
      @JsonKey(includeFromJson: false, includeToJson: false)
      final Map<String, dynamic> extraData}) = _$PulseUserImpl;

  factory _PulseUser.fromJson(Map<String, dynamic> json) =
      _$PulseUserImpl.fromJson;
  ...
  @override
  PulseGender get gender;
  @override
  int? get dob;
  @override
  List<String> get searchKeys;
  @override
  PulseOnlineStatus get onlineStatus;
  @override
